...
🗺️ [**Buscador de países**](https://github.com/Aemete8/Buscador-de-paises) — Explorador de países construido con HTML, CSS y JavaScript vanilla. Consume la API de Countries Dev mostrando bandera, capital, población, idiomas, monedas y fronteras de cada país. Implementa búsqueda en tiempo real en español e inglés, filtrado combinado por región, vista de detalle con navegación entre vistas y restauración del scroll al volver al listado. Sigue buenas prácticas de HTML semántico, diseño mobile-first, manejo de casos borde y documentación JSDoc.
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=Aemete8&show_icons=true&theme=tokyonight&hide_border=true" alt="GitHub Stats" />
  <br/>
